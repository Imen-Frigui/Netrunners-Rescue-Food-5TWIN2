        ...
        <li class="nav-item dropdown">
            <a role="button" class="dropdown-toggle nav-link">
                <span>
                    ...
                    <span class="hidden-md-down">Neko Neko</span>
            ...
            <div class="github-link">
                <a href="https://github.com/BRACKETS-by-TRIAD/craftable-demo" target="_blank">
                    ...
                    <img src="https://demo.getcraftable.com/images/vendor/craftable/GitHub_Logo.png" alt="">
                </a>
            </div>
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-header text-center"><strong>Account</strong></div>
                <a href="https://demo.getcraftable.com/admin/profile" class="dropdown-item"><i class="fa fa-user"></i>
                    Profile</a>
                <a href="https://demo.getcraftable.com/admin/password" class="dropdown-item"><i class="fa fa-key"></i>
                    Password</a>

                <a href="https://demo.getcraftable.com/admin/logout" class="dropdown-item"><i class="fa fa-lock"></i>
                    Logout</a>
            </div>
        </li>
    </ul>
