...
@section('content')
    <div class="container-xl">
        ...
        <form method="POST" action="{{ route('events.store') }}" novalidate class="form-horizontal form-create">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input type="text" id="name" name="name" placeholder="Name" class="form-control" required value="{{ old('name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <textarea id="description" name="description" placeholder="Event Description" class="form-control" rows="5" required>{{ old('description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input type="text" id="location" name="location" placeholder="Event Location" class="form-control" required value="{{ old('location') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input type="datetime-local" id="event_date" name="event_date" class="form-control" required value="{{ old('event_date') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input type="number" id="max_participants" name="max_participants" placeholder="Max Participants" class="form-control" required value="{{ old('max_participants') }}">
                                </div>
                            </div>
